	...
	<body>
		<header>
			...
			<div class="image-wrapper">
				...
				<div class="image-slider 1" id="1" style="background-image: url('/templates/andreanum/images/blueoverlay-min920px.svg'), url('./images/headers/intro-pic-01.jpg'); display: block;"></div>
			</div>
		...
		<div class="hidden-helper-container">
			...
			$counter = 1;
				...
				if($counter != 1){
				echo '<div class="image-slider '.$counter.'" id="'.$counter.'" style="background-image: url(/templates/andreanum/images/blueoverlay-min920px.svg),url('.$image.');"></div>';
				}
